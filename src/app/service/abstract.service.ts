...
export class AbstractService<T> {
  ...
  public toogleAtivo(item: any, ativo: boolean): Observable<object> {
    return this.http.sendPatch(this.api + '/' + item, { ativo });
  }
  ...
  public saveUpdate(object: any): Observable<object> {
    if (object.id === undefined) {
      ...
      return this.http.sendPatch(this.api + '/' + object.id, object);
    }
  }
